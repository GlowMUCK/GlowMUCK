...
extern int PropDir_Check(const char *name, const char what, const char *pre);
...
extern void add_prop_nofetch(dbref player, const char *type, const char *propertyClass, int value);
extern void add_property(dbref player, const char *type, const char *propertyClass, int value);
...
extern int has_property(dbref player, dbref what, const char *type, const char *propertyClass, int value);
extern int has_property_strict(dbref player, dbref what, const char *type, const char *propertyClass, int value);
...
extern const char *get_default_class(dbref player, const char *type);
extern int get_property_value(dbref player, const char *type);
extern dbref get_property_dbref(dbref player, const char *propertyClass);
extern struct boolexp *get_property_lock(dbref player, const char *propertyClass);
