...
dbref mesg_dbref(dbref player, dbref what, dbref perms, char *buf);
dbref mesg_dbref_mage(dbref player, dbref what, dbref perms, char *buf);
dbref mesg_dbref_strict(dbref player, dbref what, dbref perms, char *buf);
dbref mesg_dbref_local(dbref player, dbref what, dbref perms, char *buf);
...
#define MFUNARGS dbref player, dbref what, dbref perms, int argc, argv_typ argv, char *buf, int mesgtyp
