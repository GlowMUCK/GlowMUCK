...
extern void prim_convtime(PRIM_PROTOTYPE);
...
extern void prim_system(PRIM_PROTOTYPE);
extern void prim_email_password(PRIM_PROTOTYPE);

#define PRIMS_MISC_FUNCS prim_time, prim_convtime, prim_date, prim_gmtoffset, \
...
#define PRIMS_MISC_NAMES "TIME", "CONVTIME", "DATE", "GMTOFFSET", \
    ...
    "PRETTYLOCK", "TESTLOCK", "SYSPARM", "SYSTEM", "PROCTIME", "EMAIL_PASSWORD"

#define PRIMS_MISC_CNT 24
